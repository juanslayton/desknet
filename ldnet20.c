...
struct SDL_Rect line[42];  // Used to lay out keyboarding screens 
struct SDL_Rect tagline[42];  // Used to lay out keyboarding messages
                  ...
                  if(Score[e] < Win_score)
                  ...
                  else
                    {
                      ...
                      return;
                             ...
                             /* ANSWER IS BAD. */
               else if(Last_line[e][10] != Answer[e])
                 {
                   Clk[e] = time(t);
                   Goofed[e] = 1;
                   Stop[e] = 0;

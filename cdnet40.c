...
Author's address as of 26 July 2016 is 260 Sundance Ct, Azusa, CA 91792. */
  ...
  for (e = 1; e <= 40; e++)
    {
      ...
      for (c = 0; c < 20; c++)
        {
          scratch = TTF_RenderText_Solid(fnt33, &Last_line[e][c], hue[e]);
        ...
        { 
          if (Goofed[e] == 1)
            {
              if (time(t) - Clk[e] > 3) /* END OR CONTINUE TIMEOUT PENALTY. */
                {
                  Goofed[e] = 0;
                  scratch = TTF_RenderText_Solid(fnt33, "XX", white);
              ...
              if (Placeflag[e] == 1)
                 {
                   ...
                   scratch = TTF_RenderText_Solid(fnt33, &Z[0], hue[e]);
                   SDL_BlitSurface(scratch, NULL, glass, &tilem[e][10]);
                   SDL_FreeSurface(scratch);
                   SDL_UpdateWindowSurface(windowframe);
          ...
          if (Stuans[e] == Answer[e])
            { 
               for (c = 0; c < 20; c++)
                 {
                   scratch = TTF_RenderText_Solid(fnt33, &Last_line[e][c], white);
                   SDL_BlitSurface(scratch, NULL, glass, &tilem[e][c]);
                   SDL_FreeSurface(scratch);
                 }
               SDL_UpdateWindowSurface(windowframe);
          ...
          else if(Stuans[e] != Answer[e])
            {
              ...
              Z[0] = Last_line[e][10];              
              scratch = TTF_RenderText_Solid(fnt33, &Z[0], white);
              SDL_BlitSurface(scratch, NULL, glass, &tilem[e][10]);
              ...
              scratch = TTF_RenderText_Solid(fnt33, "XX" , black);
              SDL_BlitSurface(scratch, NULL, glass, &tilem[e][10]);
              SDL_FreeSurface(scratch);
              SDL_UpdateWindowSurface(windowframe);
            }
  ...
  for (e = 1; e <= 40; e++)
    {
      ...
      Score[e]=0;
      Cursor[e] = 0;
      scratch = TTF_RenderText_Solid(fnt30, TTEXT[Tta[e]], hue[e]);
               ...
               if (Ltr == 10)          
                 {
                   ...
                   if(m==249)
                     {
                       scratch=TTF_RenderText_Solid(fnt30, Rostera[e], hue[e]);
          ...
          if (Goofed[e] == 0)  /* GET STUDENT INPUT. */
            {
              ...
              if (Stuans[e] == Answer[e])
               ...
               else if(Last_line[e][11] != Answer[e])
                 {
                   ...
                   Z[0] = 'X';
                   Last_line[e][11] = 'X';
                   scratch = TTF_RenderText_Solid(fnt33, &Z[0], black);
                   SDL_BlitSurface(scratch, NULL, glass, &tilem[e][11]);
                   SDL_FreeSurface(scratch);
                   SDL_UpdateWindowSurface(windowframe);
                 }
...
poll5()
{
  ...
  for (e = 1; e <= 40; e++)
    {
      scratch=TTF_RenderText_Solid(fnt30, TTEXT[245], hue[e]);
      SDL_BlitSurface(scratch, NULL, glass, &line[e]);
      SDL_FreeSurface(scratch);
...
/* # # # # # # # # # # # # # # # # # Step 4 # # # # # # # # # # # # # # # # # # # # */
          ...
          if (Step[e] == 4)
            {
              SDL_FillRect(glass, &line[e], SDL_MapRGB(glass->format,255,255,255));
              scratch=TTF_RenderText_Solid(fnt30, TTEXT[246], hue[e]);
              SDL_BlitSurface(scratch, NULL, glass, &line[e]);
              SDL_FreeSurface(scratch);
              SDL_UpdateWindowSurface(windowframe);
          ...
          if (Step[e] == 6)
            {   
              ...
              if (Expression3[e] != Expression4[e])
                {
                  SDL_FillRect(glass, &line[e], SDL_MapRGB(glass->format,255,255,255));
                  scratch=TTF_RenderText_Solid(fnt30, TTEXT[252], hue[e]);
                  SDL_BlitSurface(scratch, NULL, glass, &line[e]);
                  SDL_FreeSurface(scratch);
                  SDL_UpdateWindowSurface(windowframe);
                  Clk[e] = time(t);
               ...
               if (Expression3[e] == Expression4[e])
                {
                  SDL_FillRect(glass, &line[e], SDL_MapRGB(glass->format,255,255,255));
                  scratch=TTF_RenderText_Solid(fnt30, TTEXT[251], hue[e]);
                  SDL_BlitSurface(scratch, NULL, glass, &line[e]);
                  SDL_FreeSurface(scratch);
                  SDL_UpdateWindowSurface(windowframe);
                  Clk[e] = time(t);
...
process()
{
  ...
  SDL_RenderClear(rends);
           ...
           /* COPY OPENING LINES OF 40 STUDENTS TO THE SCREEN. */
  for (e = 1; e <= 40; e++)
    {
      Cursor[e] = 0;
      for (a = 0; a < 20; a++)
       {
         Display_line[e][a] = Comp[e][Text_pos[e] + a];
          ...
          for (b = 0; b < 20; b++)
            {
              scratch = TTF_RenderText_Solid(fnt30, &Display_line[e][b] , hue[e]);
...
{
 SDL_FillRect(glass, &line[e], SDL_MapRGB(glass->format,255,255,255));
  TTF_RenderText_Solid(fnt30, TTEXT[245], hue[e]);
  SDL_BlitSurface(scratch, NULL, glass, &line[e]);
  SDL_FreeSurface(scratch);
  SDL_UpdateWindowSurface(windowframe);
           ...
           if (Goofed[e] == 0)
             {
               ...
               if (Stuans[e] == Answer[e])
               ...
               else if(Last_line[e][11] != Answer[e])
                 {
                   ...
                   Last_line[e][11] = 'X';
                   scratch = TTF_RenderText_Solid(fnt33, &Last_line[e][11], black);
                   SDL_BlitSurface(scratch, NULL, glass, &tilem[e][11]);
                   SDL_FreeSurface(scratch);
                   SDL_UpdateWindowSurface(windowframe);
                 }
